...
public class MyFramePatient27 extends JFrame
{
	...
	//	label_select.add(lp4);
		...
		lt1 = new JLabel("Dr.Rakesh Soni");
		lt1.setBounds(300,30,200,50);
		lt1.setVisible(true);
		label_select.add(lt1);
		lt1.setFont(f1);
		
		lt2 = new JLabel("Dr.Pankaj Sharma");
		...
		lt10.setFont(f1);
		*/
		lt4 = new JLabel("Neurologist-12 years of experience overall");
		...
		lt5 = new JLabel("Neurologist-9 years of experience overall");
