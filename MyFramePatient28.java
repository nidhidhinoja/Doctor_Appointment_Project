...
public class MyFramePatient28 extends JFrame
{
	...
	//	label_select.add(lp4);
		...
		lt10.setFont(f1);
		*/
		lt4 = new JLabel("Homeopathic-12 years of experience overall");
		...
		lt5 = new JLabel("Homeopathic-9 years of experience overall");
