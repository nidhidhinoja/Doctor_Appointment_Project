...
public class MyFramePatient15 extends JFrame
{
	
	Font f1,f2;
	JButton b1,b2,bt1,bt2,bt3,bt4,bt5,bt6,bt7,bt8,bt9;
	JLabel label_login,l1,l2,l3;
	
	MyActionListener mli = new MyActionListener(this);
	
	MyFramePatient15(String s)
	{
		super("APPOINTMENT");
		...
		bt2.setBounds(530,400,100,50);
		bt3.setBounds(645,400,100,50);
		bt4.setBounds(760,400,100,50);
		bt5.setBounds(875,400,100,50);
		bt6.setBounds(990,400,100,50);
		//bt7.setBounds(415,600,100,50);
		bt8.setBounds(530,600,100,50);
		bt9.setBounds(645,600,100,50);
		
		l1.setBounds(100,400,300,50);
		l2.setBounds(100,600,300,50);
		l3 = new JLabel("----8 Slots Available----");
