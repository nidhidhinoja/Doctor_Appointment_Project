...
public class MyFramePatient26 extends JFrame
{
	...
	//	label_select.add(lp4);
		...
		lt10.setFont(f1);
		*/
		lt4 = new JLabel("Ayurveda - 12 years of experience overall");
		...
		lt5 = new JLabel("Ayurveda - 9 years of experience overall");
