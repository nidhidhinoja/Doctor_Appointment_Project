...
public class MyFramePatient22 extends JFrame
{
	...
	//	label_select.add(lp4);
		...
		lt10.setFont(f1);
		*/
		lt4 = new JLabel("Physian-12 years of experience overall");
		...
		lt5 = new JLabel("Physian-9 years of experience overall");
